        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            while (true) {
                try {
                    ...
                    String time = "Date: " + java.time.LocalDate.now() + " Time: " + java.time.LocalTime.now();

                    ClientConnectionData client = new ClientConnectionData(socket, socketIn, socketOut, name,time);
